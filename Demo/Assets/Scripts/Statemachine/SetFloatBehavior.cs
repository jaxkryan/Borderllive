...
public class SetFloatBehavior : StateMachineBehaviour
{
    ...
    override public void OnStateMachineEnter(Animator animator, int stateMachinePathHas)
    {
    ...
    override public void OnStateMachineExit(Animator animator, int stateMachinePathHas)
    {
