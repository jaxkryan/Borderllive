...
public class ExchangeUI : MonoBehaviour
{
        ...
        [SerializeField] Text soulAmountText;
        [SerializeField] Text xpAmountText;
        ...
        private void Update()
        {
            ...
            soulAmountText.text = "Spend: " + soulToXPExchangeSlider.value.ToString() + " souls";
            xpAmountText.text = " for " + (soulToXPExchangeSlider.value * 2).ToString() + " XP?";
